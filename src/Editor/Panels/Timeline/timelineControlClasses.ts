...
export const TIMELINE_DROP_TARGET_ROOT_CLASSES =
  "timeline-drop-target-root flex h-full w-full flex-col";

export const TIMELINE_ROOT_CONTAINER_CLASSES =
  "timeline-root-container relative flex h-full flex-1 flex-col bg-[#3B3B3B] min-h-0 select-none [-webkit-user-drag:none] [&_img]:[-webkit-user-drag:none]";

export const TIMELINE_CLASSIC_GRID_CLASSES =
  "timeline-classic-grid min-h-0 w-full flex-1 border-b-[4px] border-l-[4px] border-[#191919] bg-[#303030]";

export const getTimelineShortcutToggleButtonClasses = (
  active: boolean
): string =>
  withActiveClass(
    "timeline-shortcut-toggle-button h-[26px] min-w-[56px] border-none bg-transparent px-[10px] font-nunito text-[11px] font-extrabold uppercase tracking-[0.03em] text-[#BDBDBD] has-hover:bg-[rgba(255,255,255,0.08)] [@media(max-height:820px)]:h-6 [@media(max-height:820px)]:min-w-[52px] [@media(max-height:820px)]:px-2 [@media(max-height:820px)]:text-[10px] max-[800px]:h-[34px] max-[800px]:min-w-[74px] max-[800px]:text-[12px] [@media(max-width:800px)_and_(max-height:820px)]:h-[34px] [@media(max-width:800px)_and_(max-height:820px)]:min-w-[74px] [@media(max-width:800px)_and_(max-height:820px)]:text-[12px]",
    active,
...
export const getTimelineRendererToggleButtonClasses = (
  ...
  withActiveClass(
    "timeline-renderer-toggle-button h-[26px] min-w-[64px] border-none bg-transparent px-[10px] font-nunito text-[11px] font-extrabold uppercase tracking-[0.04em] text-[#BDBDBD] has-hover:bg-[rgba(255,255,255,0.08)] [@media(max-height:820px)]:h-6 [@media(max-height:820px)]:min-w-[60px] [@media(max-height:820px)]:px-2 [@media(max-height:820px)]:text-[10px] max-[800px]:h-[34px] max-[800px]:min-w-[74px] max-[800px]:text-[12px] [@media(max-width:800px)_and_(max-height:820px)]:h-[34px] [@media(max-width:800px)_and_(max-height:820px)]:min-w-[74px] [@media(max-width:800px)_and_(max-height:820px)]:text-[12px]",
    active,
...
export const getTimelineHeaderOptionsButtonClasses = (
  ...
  withActiveClass(
    "timeline-header-options-button h-[26px] min-w-[92px] rounded-[6px] border border-[#191919] bg-[rgba(255,255,255,0.02)] px-[10px] font-nunito text-[11px] font-extrabold uppercase tracking-[0.03em] text-[#BDBDBD] has-hover:bg-[rgba(255,255,255,0.08)] [@media(max-height:820px)]:h-6 [@media(max-height:820px)]:min-w-[82px] [@media(max-height:820px)]:px-2 [@media(max-height:820px)]:text-[10px] max-[800px]:h-[34px] max-[800px]:min-w-[96px] max-[800px]:text-[12px] [@media(max-width:800px)_and_(max-height:820px)]:h-[34px] [@media(max-width:800px)_and_(max-height:820px)]:min-w-[96px] [@media(max-width:800px)_and_(max-height:820px)]:text-[12px]",
    active,
...
export const TIMELINE_HEADER_CLASSES =
  "timeline-flash-header flex items-start gap-[10px] overflow-x-auto overflow-y-visible border-b border-[#191919] bg-[linear-gradient(to_bottom,#303030,#3B3B3B)] px-[10px] py-[6px] font-nunito text-[12px] text-white [scrollbar-width:thin] [@media(max-height:820px)]:gap-2 [@media(max-height:820px)]:px-2 [@media(max-height:820px)]:py-1 max-[800px]:flex-wrap max-[800px]:gap-x-[10px] max-[800px]:gap-y-1 max-[800px]:px-2 max-[800px]:py-[6px] [@media(max-width:800px)_and_(max-height:820px)]:gap-x-[10px] [@media(max-width:800px)_and_(max-height:820px)]:gap-y-1 [@media(max-width:800px)_and_(max-height:820px)]:px-2 [@media(max-width:800px)_and_(max-height:820px)]:py-[6px]";
...
export const TIMELINE_ACTION_BUTTON_CLASSES =
  "timeline-flash-action-button h-[26px] w-[26px] min-w-[26px] rounded-[4px] border border-[rgba(255,255,255,0.08)] [@media(max-height:820px)]:h-6 [@media(max-height:820px)]:w-6 [@media(max-height:820px)]:min-w-6 max-[800px]:h-10 max-[800px]:w-10 max-[800px]:min-w-10 [@media(max-width:800px)_and_(max-height:820px)]:h-10 [@media(max-width:800px)_and_(max-height:820px)]:w-10 [@media(max-width:800px)_and_(max-height:820px)]:min-w-10";
...
export const TIMELINE_HEADER_RIGHT_CLASSES =
  "timeline-flash-header-right flex min-w-0 flex-1 flex-col items-end gap-[6px] max-[800px]:w-full max-[800px]:items-stretch";

export const TIMELINE_HEADER_RIGHT_PRIMARY_CLASSES =
  "timeline-flash-header-right-primary inline-flex w-full flex-wrap items-center justify-end gap-2 max-[800px]:justify-start";

export const getTimelineHeaderRightAdvancedClasses = (
  open: boolean
): string =>
  [
    "timeline-flash-header-right-advanced w-full flex-wrap items-center justify-end gap-2 border-t border-t-[rgba(255,255,255,0.08)] pt-1 max-[800px]:justify-start",
...
export const TIMELINE_FOOTER_CLASSES =
  "timeline-flash-footer sticky bottom-0 left-0 z-40 mt-auto flex shrink-0 items-center gap-2 overflow-x-auto overflow-y-hidden border-t border-[#191919] bg-[#303030] px-2 py-[6px] shadow-[0_-6px_12px_rgba(0,0,0,0.22)] [scrollbar-width:thin] [@media(max-height:820px)]:gap-[6px] [@media(max-height:820px)]:py-1 max-[800px]:gap-[6px] max-[800px]:px-[10px] max-[800px]:py-2 [@media(max-width:800px)_and_(max-height:820px)]:px-[10px] [@media(max-width:800px)_and_(max-height:820px)]:py-2";
...
export const TIMELINE_DOM_GRID_SCROLL_CLASSES =
  "timeline-dom-grid-scroll relative overscroll-contain [touch-action:pan-x_pan-y]";
...
export const TIMELINE_DOM_LAYERS_HEADER_CLASSES =
  "timeline-dom-layers-header sticky top-0 z-[3] flex h-[34px] items-center border-b border-[#191919] bg-[#303030] px-[10px] font-nunito text-[11px] font-extrabold uppercase tracking-[0.06em] text-[#BDBDBD] [@media(max-height:820px)]:h-[30px]";

export const TIMELINE_DOM_LAYERS_SUBHEADER_CLASSES =
  "timeline-dom-layers-subheader z-[3] flex h-[34px] shrink-0 items-center justify-end border-b border-b-[rgba(255,255,255,0.08)] bg-[#303030] px-2 [@media(max-height:820px)]:h-[30px] max-[800px]:h-10 max-[800px]:basis-10 [@media(max-width:800px)_and_(max-height:820px)]:h-10 [@media(max-width:800px)_and_(max-height:820px)]:basis-10";
...
export const getTimelineDomLayerRowClasses = (
  ...
  [
    "timeline-dom-layer-row grid grid-cols-[1fr_30px_30px_30px] items-center gap-1 border-b border-b-[rgba(255,255,255,0.06)] px-[6px] py-1 max-[800px]:grid-cols-[1fr_38px_38px_38px] max-[800px]:p-[6px]",
...
export const TIMELINE_DOM_LAYER_MAIN_CLASSES =
  "timeline-dom-layer-main inline-flex h-[calc(var(--timeline-cell-height)-10px)] min-w-0 touch-none items-center rounded-[4px] border border-transparent bg-transparent px-2 text-left text-white max-[800px]:min-h-[38px]";
...
export const TIMELINE_DOM_LAYER_ICON_BUTTON_CLASSES =
  "timeline-dom-layer-icon-button inline-flex h-7 w-7 touch-none items-center justify-center rounded-[4px] border border-[rgba(255,255,255,0.1)] bg-[#383434] p-0 max-[800px]:h-9 max-[800px]:w-9";

export const TIMELINE_DOM_LAYER_DELETE_BUTTON_CLASSES =
  "timeline-dom-layer-delete-button inline-flex h-7 w-7 touch-none items-center justify-center rounded-[4px] border border-[rgba(255,255,255,0.1)] bg-[#383434] p-0 max-[800px]:h-9 max-[800px]:w-9";
...
export const TIMELINE_DOM_MARKER_ROW_CLASSES =
  "timeline-dom-marker-row flex h-[34px] items-stretch overflow-hidden border-b border-[#191919] bg-[linear-gradient(to_bottom,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] [@media(max-height:820px)]:h-[30px] max-[800px]:min-h-10";
...
export const TIMELINE_DOM_WORK_AREA_HANDLE_CLASSES =
  "timeline-dom-work-area-handle absolute top-[6px] z-[4] h-[22px] w-[10px] touch-none -translate-x-1/2 rounded-full border border-[rgba(255,243,192,0.65)] bg-[rgba(255,243,192,0.65)] p-0 before:absolute before:inset-[-10px] before:content-['']";
...
export const TIMELINE_DOM_NUMBERLINE_CLASSES =
  "timeline-dom-numberline sticky top-0 z-[2] flex h-[34px] items-stretch overflow-hidden border-b border-[#191919] bg-[#303030] [@media(max-height:820px)]:h-[30px] max-[800px]:h-10 max-[800px]:basis-10 [@media(max-width:800px)_and_(max-height:820px)]:h-10 [@media(max-width:800px)_and_(max-height:820px)]:basis-10";
...
export const getTimelineDomDropModeClasses = (
  ...
  [
    "timeline-dom-drop-mode pointer-events-none absolute right-3 top-[10px] z-[11] inline-flex h-[22px] items-center rounded-full border border-transparent px-2 font-nunito text-[10px] font-extrabold uppercase tracking-[0.03em] max-[800px]:right-2 max-[800px]:top-[6px] max-[800px]:text-[11px]",
    mode === "overwrite"
...
const TIMELINE_DOM_TWEEN_BASE_CLASSES =
  "timeline-dom-tween absolute top-1/2 z-[2] box-border h-[10px] w-[10px] touch-none -translate-y-1/2 rotate-45 rounded-[1.5px] border-[1.5px] border-[rgba(255,255,255,0.85)] bg-[rgba(152,214,255,0.6)] p-0 transition-[transform,border-color] duration-100 [transition-timing-function:ease] after:absolute after:inset-[-9px] after:content-[''] max-[800px]:h-[18px] max-[800px]:w-[18px] max-[800px]:after:inset-[-12px] [&[data-tween-state='tween-span']]:border-[rgba(152,214,255,0.76)] [&[data-tween-state='tween-span']]:bg-[rgba(152,214,255,0.26)]";
...
export const TIMELINE_FOOTER_GROUP_CLASSES =
  "timeline-flash-footer-group inline-flex items-center gap-[6px] border-r border-r-[rgba(255,255,255,0.08)] px-1 py-[2px] last:border-r-0 max-[820px]:px-[3px] max-[820px]:py-[1px] max-[800px]:min-h-[42px]";
...
export const TIMELINE_FOOTER_INPUT_CLASSES =
  "timeline-flash-footer-input h-7 w-[62px] rounded border border-[#191919] bg-[#383434] px-[6px] py-1 font-nunito text-xs font-bold text-white [@media(max-height:820px)]:h-6 [@media(max-height:820px)]:text-[11px] max-[800px]:h-[34px] max-[800px]:text-[13px] [@media(max-width:800px)_and_(max-height:820px)]:h-[34px] [@media(max-width:800px)_and_(max-height:820px)]:text-[13px]";
...
export const TIMELINE_FOOTER_HINT_CLASSES =
  "timeline-flash-footer-hint ml-auto whitespace-nowrap font-nunito text-[10px] text-[#BDBDBD] max-[820px]:hidden max-[800px]:text-[11px]";
...
export const TIMELINE_FOOTER_BUTTON_CLASSES =
  "timeline-flash-footer-button h-7 min-w-[32px] rounded border border-[rgba(255,255,255,0.12)] bg-[#383434] px-2 font-nunito text-xs font-extrabold text-white has-hover:bg-[#4A4A4A] enabled:active:bg-[#525252] [@media(max-height:820px)]:h-6 [@media(max-height:820px)]:text-[11px] max-[800px]:h-[34px] max-[800px]:min-w-9 max-[800px]:text-[12px] [@media(max-width:800px)_and_(max-height:820px)]:h-[34px] [@media(max-width:800px)_and_(max-height:820px)]:min-w-9 [@media(max-width:800px)_and_(max-height:820px)]:text-[12px]";

export const getTimelineFooterChoiceClasses = (active: boolean): string =>
  withActiveClass(
    "timeline-flash-footer-choice inline-flex h-7 min-w-[34px] items-center justify-center gap-1 rounded border border-[rgba(255,255,255,0.12)] bg-[#383434] px-2 font-nunito text-[11px] font-bold text-white has-hover:bg-[#4A4A4A] enabled:active:bg-[#525252] [@media(max-height:820px)]:h-6 [@media(max-height:820px)]:text-[11px] max-[800px]:h-[34px] max-[800px]:min-w-9 max-[800px]:text-[12px] [@media(max-width:800px)_and_(max-height:820px)]:h-[34px] [@media(max-width:800px)_and_(max-height:820px)]:min-w-9 [@media(max-width:800px)_and_(max-height:820px)]:text-[12px]",
    active,
...
export const TIMELINE_SCENE_NAME_CLASSES =
  "timeline-flash-scene-name max-w-[260px] overflow-hidden text-ellipsis whitespace-nowrap font-bold text-white max-[800px]:max-w-[180px]";

export const TIMELINE_META_CLASSES =
  "timeline-flash-meta mr-auto whitespace-nowrap text-[#BDBDBD] [font-variant-numeric:tabular-nums] max-[800px]:mr-0 max-[800px]:w-full";
