...
class Toolbox extends Component {
  ...
  renderToolButtonsMobile = () => {
    ...
    for (let i = 0; i < Object.keys(this.toolDropdowns).length; i++) {
      if (
        typeof this.toolDropdowns[Object.keys(this.toolDropdowns)[i]] ===
          "object" &&
        this.toolDropdowns[Object.keys(this.toolDropdowns)[i]].options.indexOf(
          activeToolName
        ) !== -1
      ) {
        this.toolDropdowns[Object.keys(this.toolDropdowns)[i]].active =
          activeToolName;
      }
    }
    return (
  ...
  render() {
    this.toolButtonProps.className = classNames("toolbox-item", {
      mobile: this.props.renderSize === "small",
    });
    return (
