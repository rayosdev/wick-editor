        ...
        <div className="add-script-tabs">
          <button
            className={classNames("add-script-tab", "we-event", "Mouse", {
              selected: "Mouse" === this.props.addScriptTab,
            })}
          ...
          <button
            className={classNames("add-script-tab", "we-event", "Keyboard", {
              selected: "Keyboard" === this.props.addScriptTab,
            })}
          ...
          <button
            className={classNames("add-script-tab", "we-event", "Timeline", {
              selected: "Timeline" === this.props.addScriptTab,
            })}
          ...
          {this.props.scripts.map((script, i) => {
            return (
              <button
                ...
                disabled={
                  this.props.availableScripts &&
                  this.props.availableScripts.indexOf(script.name) === -1
                }
                onClick={() =>
                  this.props.addScript && this.props.addScript(script.name)
                }
              >
