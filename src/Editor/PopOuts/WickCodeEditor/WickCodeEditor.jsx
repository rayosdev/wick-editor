...
export default function WickCodeEditor(props) {
  ...
  props.script &&
    props.script.scripts.sort(props.scriptInfoInterface.sortScripts);
            ...
            <tr>
              ...
              <td>
                <select
                  ...
                  onChange={(e) => {
                    props.updateCodeEditorWindowProperties({
                      theme: editorThemeSelectRef.current.value,
                    });
                  }}
                >
  ...
  if (props.script) {
    let script = props.script.scripts.find(
      (s) => s.name === props.scriptToEdit
    );
    if (script) {
  ...
  function renderCodeTabs() {
    return (
      <div className="wick-code-editor-tabs">
        {props.script &&
          props.script.scripts.map((script) => {
            return (
              <button
    ...
    return (
      ...
      >
        {props.scriptToEdit === "add" && (
          <AddScriptPanel
            availableScripts={
              props.script && props.script.getAvailableScripts()
            }
            scripts={props.scriptInfoInterface.scriptData.filter(
              (script) => script.type === addScriptTab
            )}
        ...
        <div className="we-code-editor-small">
          <div className="wick-code-editor-drag-handle small">
            <div className="we-code-editor-title small">
              Code Editor |{" "}
              <div className="we-code-editor-title-selected">{`editing ${props.selectionType}`}</div>
            </div>
            <ActionButton
          ...
          <div className="wick-code-editor-content">
            ...
            <ReflexContainer>
              ...
              <ReflexElement
                minSize={40}
                size={
                  props.codeEditorWindowProperties.consoleOpen
                    ? props.codeEditorWindowProperties.consoleHeight
                    : 1
                }
          ...
          {codeOptions.map((option) => (
            ...
            >
              <ActionButton
                ...
                action={() => {
                  props.addCodeToTab(option.snippet);
                }}
