...
test.describe('Drawing and Selection Test', () => {
  test('draws lines and tests selection functionality', async ({ page }) => {
    ...
    const projectInfo = await page.evaluate(() => {
      if (window.project) {
        ...
        return {
          ...
          selectedObjects: project.selection ? project.selection.getSelectedObjects() : []
        };
      }
    ...
    await page.screenshot({ path: 'test-results/drawing-selection-test.png', fullPage: true });
